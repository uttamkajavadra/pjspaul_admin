...
class _OtherScreenState extends State<OtherScreen> {
  OtherController controller = Get.isRegistered<OtherController>() ? Get.find<OtherController>() : Get.put(OtherController());
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          //               "PJS Paul Ministries Offices", 
          //               "Life Changing Messages Live", 
          //               "Email Us", 
          //               "Donations"],
          //             onChanged: (index) {
