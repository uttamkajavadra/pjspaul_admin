...
class _BeliverRegistrationScreenState extends State<BeliverRegistrationScreen> {
  BeliverRegistrationController controller = Get.isRegistered<BeliverRegistrationController>() 
    ? Get.find<BeliverRegistrationController>() : Get.put(BeliverRegistrationController());
